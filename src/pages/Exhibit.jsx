...
const Exhibit = () => {
  ...
  const deliveryCost = ["送料込み（出品者負担）", "着払い（購入者負担）"];

  const categories = ["キムチ", "カクテキ", "elon"];
  ...
  return (
    <>
      ...
      <SExhibit>
        ...
        <SInputContent>
          <SSubTitle theme={theme}>
            <div>① 商品画像</div>
            <SRequired theme={theme}>必須</SRequired>
          </SSubTitle>
          <ImageUpload
            ...
            setZooms={setZooms}
          />
          <SErrorMessage theme={theme}>
            エラーメッセージエラーメッセージエラーメッセージエラーメッセージエラーメッセージエラーメッセージエラーメッセージエラーメッセージ
          </SErrorMessage>
        </SInputContent>
        ...
        <SInputContent>
          ...
          <ProductPriceInput
            product={product}
            handleProductPriceInput={handleProductPriceInput}
          />
          <SErrorMessage theme={theme}>
            エラーメッセージエラーメッセージエラーメッセージエラーメッセージエラーメッセージエラーメッセージエラーメッセージエラーメッセージ
          </SErrorMessage>
        ...
        <SInputContent>
          ...
          <ProductShippingAreaInput
            product={product}
            handleShippingAreaChange={handleShippingAreaChange}
