...
const Home = () => {
  ...
  const products = [
    {
      id: 1,
      productName: "HARDCORE TANO*C",
      sallerId: "tanoc_net",
      imageUrl: `${siteAssetsPath}/tanoc_icon_black.png`,
      point: 300,
    },
    {
      id: 2,
      productName: "HARDCORE TANO*C",
      sallerId: "tanoc_net",
      imageUrl: `${siteAssetsPath}/tanoc_icon.png`,
      point: 300,
    },
    {
      id: 3,
      productName: "HARDCORE TANO*Cccccccccccccccccccccccccccccccccccccccc",
      sallerId: "tanoc_net",
      imageUrl: `${siteAssetsPath}/tanoc_icon.png`,
      point: 300,
    },
    {
      id: 4,
      productName: "HARDCORE TANO*Caaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
      sallerId: "tanoc_net",
      imageUrl: `${siteAssetsPath}/tanoc_icon.png`,
      point: 300,
    },
    {
      id: 5,
      productName: "HARDCORE TANO*Cあああああああああああああああ",
      sallerId: "tanoc_net",
      imageUrl: `${siteAssetsPath}/tanoc_icon_black.png`,
      point: 300,
    },
    ...
    },
    {
      id: 8,
      productName: "いーろん",
      sallerId: "twitter_japan",
      imageUrl: `${siteAssetsPath}/elon.png`,
      point: 9999999,
    },
    {
      id: 9,
      productName: "ショウガにミソ付けて食べるの美味しいのにあまり理解されない",
      sallerId: "tanoc_net",
      imageUrl: `${siteAssetsPath}/tanoc_icon.png`,
      point: 300,
    },
    {
      id: 10,
      productName:
        "自分で作った回路に電気が流れてさ、チェストにものがどんどん貯まっていくってもうあり得ない快感なんだよね",
      sallerId: "tanoc_net",
      imageUrl: `${siteAssetsPath}/tanoc_icon.png`,
      point: 300,
    },
    ...
    {
      id: 13,
      productName: "伊勢エビ(戦闘力53万)",
      sallerId: "elonmusk",
      imageUrl: `${siteAssetsPath}/iseebi.png`,
      point: 4000,
    },
  ];
  const limitedProducts = isXsScreen
    ? products.slice(0, 6)
    : isSmallScreen
    ? products.slice(0, 9)
    : isMiddleScreen
        ...
        <StyledSlider {...slideSettings} theme={theme}>
          {slides.map((slide) => (
            <StyledSlide key={slide.id} slideUrl={slide.imageUrl} theme={theme}>
              <StyledSlideComment theme={theme} $isXsScreen={isXsScreen}>
                {slide.slideComment}
              </StyledSlideComment>
            </StyledSlide>
          ))}
            ...
            {limitedProducts.map((product) => (
              ...
              >
                ...
                <StyledProductDesc>
                  ...
                  <StyledSellerId
                    theme={theme}
                  >{`by @${product.sallerId}`}</StyledSellerId>
                  <StyledPriceAndLike>
                    <StyledPrice
                      theme={theme}
                    >{`${product.point} ポイント`}</StyledPrice>
                ...
                >
                  <StyledPopperPaper elevation={3} theme={theme}>
                    <StyledPopperItem theme={theme} onClick={handleLinkCopy}>
                      リンクをコピー
                    </StyledPopperItem>
                    <StyledPopperItem theme={theme}>共有</StyledPopperItem>
                    <StyledPopperItem theme={theme}>
                      いいねする
                    </StyledPopperItem>
                  </StyledPopperPaper>
                </Popper>
                    ...
                    >
                      ...
                      >
                        ...
                        <Hidden only={["xs", "sm"]}>
                          ...
                          >
                            <StyledUserSlideName theme={theme}>
                              {userSlide.userName}
                            </StyledUserSlideName>
                            <StyledUserSlideId
                              theme={theme}
                            >{`@${userSlide.userId}`}</StyledUserSlideId>
                          </div>
                        </Hidden>
                        <Tooltip
                          title="フォローする"
...
const StyledUserGridItemProduct = styled(Grid)`
  && {
    ...
    gap: 10px;
    height: ${(props) =>
      props.$isXsScreen ? "100px" : props.$isSmallScreen ? "100px" : "400px"};
    widht: 100%;
    overflow: hidden;
  }
`;
  ...
  && {
    ...
    height: ${(props) =>
      props.$isXsScreen
        ...
        : "150px"};
    margin: ${(props) =>
        props.$isXsScreen ? "20px" : props.$isSmallScreen ? "20px" : "50px"}
      auto 0 auto;
  }
`;
...
const StyledFollowTab = styled(Chip)`
  && {
    ...
    max-width: 250px;
    margin: ${(props) =>
        props.$isXsScreen ? "0" : props.$isSmallScreen ? "0" : "0px"}
      auto 0 auto;
  }
`;
