...
const UseProduct = (props) => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get(`${backendAccessPath}/client/product/getOrderUser/${props.user._id}?page=${1}&pageSize=${pageSize}`);
    ...
    useEffect(() => {
        ...
        try {
            const response = await axios.get(`${backendAccessPath}/client/product/getOrderUser/${props.user._id}?page=${pageNumber + 1}&pageSize=${pageSize}`);
