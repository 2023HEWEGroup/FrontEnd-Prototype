...
const TopModal = (props) => {
  ...
  const [recognitionPasswordVisible, setRecognitionPasswordVisible] =
    useState(false);
  ...
  return (
    <>
        ...
        {isLogin ? (
          ...
          >
            <Tooltip title="閉じる" placement="top">
              <SHighlightOff onClick={handleModalClose} />
            </Tooltip>
            <SModalIntro $isLogin={isLogin}>
              マーケットにログインしましょう
            </SModalIntro>
            <LoginForm
              isUserIdLogin={isUserIdLogin}
              handleIsLogin={handleIsLogin}
              userId={userId}
              mailAddress={mailAddress}
              password={password}
              handleUserIdInput={handleUserIdInput}
              handleMailAddressInput={handleMailAddressInput}
              handlePasswordInput={handlePasswordInput}
              handleUserIdLogin={handleUserIdLogin}
          ...
          >
            ...
            <SModalIntro $isLogin={isLogin}>アカウントを作成する</SModalIntro>
              ...
              {currentStep === 0 && (
                <>
                  ...
                  <RegistUserInfo
                    ...
                    registConfirmMailAddress={registConfirmMailAddress}
                    handleRegistUserNameInput={handleRegistUserNameInput}
                    handleRegistUserIdInput={handleRegistUserIdInput}
                    handleRegistPasswordInput={handleRegistPasswordInput}
                    handleRegistConfirmPasswordInput={
                      handleRegistConfirmPasswordInput
                    }
                    handleRegistMailAddressInput={handleRegistMailAddressInput}
                    handleRegistConfirmMailAddressInput={
                      handleRegistConfirmMailAddressInput
                    }
                  />
                  <RegistChangeStep
              ...
              {currentStep === 1 && (
                <>
                  ...
                  <RegistPersonalInfo
                    ...
                    handleUpperNameInput={handleUpperNameInput}
                    handleLowerNameInput={handleLowerNameInput}
                    handleUpperNameKanaInput={handleUpperNameKanaInput}
                    handleLowerNameKanaInput={handleLowerNameKanaInput}
                    handlePostalCodeInput={handlePostalCodeInput}
                    handleHouseNumberInput={handleHouseNumberInput}
              ...
              {currentStep === 2 && (
                <>
                  ...
                  <RegistCreditCard
                    ...
                    handleCreditCardNumberChange={handleCreditCardNumberChange}
                    handleCreditCardExpiryChange={handleCreditCardExpiryChange}
                    handleCreditCardCVCChange={handleCreditCardCVCChange}
                    CVCVisible={CVCVisible}
                    handleCVCVisible={handleCVCVisible}
              ...
              {currentStep === 3 && (
                <>
                  ...
                  <RegistRecognition
                    ...
                    phoneNumber={phoneNumber}
                    creditCard={creditCard}
                    recognitionPasswordVisible={recognitionPasswordVisible}
                    handleRecognitionPasswordVisible={
                      handleRecognitionPasswordVisible
                    }
                    recognitionCVCVisible={recognitionCVCVisible}
                    handleRecognitionCVCVisible={handleRecognitionCVCVisible}
                    meta={meta}
                    getCardImageProps={getCardImageProps}
                  />
                  <RegistChangeStep
      ...
      <DestructionModal
        isDestructOpen={isDestructOpen}
        handleInputDelete={handleInputDelete}
        setIsDestructOpen={setIsDestructOpen}
        header="入力内容を破棄しますか？"
        desc="この操作は取り消しできません。変更は失われます。"
      />
    </>
  );
};
