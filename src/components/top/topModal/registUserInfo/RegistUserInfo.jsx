...
const RegistUserInfo = (props) => {
    ...
    return (
        ...
        <StyledTextField style={{marginBottom: "15px"}} helperText=" " theme={theme} fullWidth label="ユーザーネーム (1~30字)" required
            autoComplete='new-off' variant='outlined' inputProps={{maxLength: 30}} value={props.registUserName} onChange={props.handleRegistUserNameInput}/>
        <StyledTextField style={{marginBottom: "15px"}} helperText=" " theme={theme} fullWidth label="ユーザーID (3~20字)" required
            autoComplete='new-off' variant='outlined' inputProps={{maxLength: 20}} value={props.registUserId} onChange={props.handleRegistUserIdInput}/>
