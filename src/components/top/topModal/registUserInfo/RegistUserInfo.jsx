...
const RegistUserInfo = (props) => {
    ...
    return (
        <>
        <StyledTextFieldTop style={{marginBottom: "15px"}} helperText={props.registUserNameHelper} theme={theme} fullWidth label="ユーザーネーム (1~30字)" required
        ...
        <StyledTextFieldTop style={{marginBottom: "15px"}} helperText={props.registUserIdHelper} theme={theme} fullWidth label="ユーザーID (3~30字)" required
        ...
        <StyledTextFieldTop style={{marginBottom: "15px"}} helperText={props.registPasswordHelper} theme={theme} fullWidth label="パスワード (8~20字)" required error={props.isRegistPasswordError}
        ...
        <StyledTextFieldTop style={{marginBottom: "15px"}} helperText={props.registConfirmPasswordHelper} theme={theme} fullWidth label="確認用パスワード (8~20字)" required error={props.isRegistConfirmPasswordError}
            ...
            InputProps={{endAdornment: (<InputAdornment position="end" onClick={handleRegistPasswordVisible}>{registPasswordVisible ? <StyledVisibility /> : <StyledVisibilityOff />}</InputAdornment>)}}/>
        <StyledTextFieldTop style={{marginBottom: "15px"}} helperText={props.registMailAddressHelper} theme={theme} fullWidth label="メールアドレス" required error={props.isRegistMailAddressError}
        ...
        <StyledTextFieldTop style={{marginBottom: "15px"}} helperText={props.registConfirmMailAddressHelper} theme={theme} fullWidth label="確認用メールアドレス" required error={props.isRegistConfirmMailAddressError}
